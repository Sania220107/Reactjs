...
const CTA = () => {
  return (
    <section className='bg-custom-blue-light overflow-hidden relative mb-7' style={{padding:'20px', margin:'0 auto', maxWidth:'90%', borderRadius:'10px'}}>
      <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 gap-8'>
        ...
        <div>
          ...
          <p className=' text-light subtitle text-3xl lg:text-3xl font-bold !leading-snug'>We always give our customer a promo to gave the appreciate for loyalty to us. Just subscribe to us :)</p>
